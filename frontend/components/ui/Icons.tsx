...
export const HomeIcon     = icon("M3 9.5L12 3l9 6.5V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9.5z M9 21V12h6v9");
export const SearchIcon   = icon("M11 19a8 8 0 1 0 0-16 8 8 0 0 0 0 16z M21 21l-4.35-4.35");
export const ComposeIcon  = icon("M12 5H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7 M17.5 2.5a2.121 2.121 0 0 1 3 3L12 14l-4 1 1-4 7.5-7.5z");
...
export const RepeatIcon   = icon("M17 1l4 4-4 4 M3 11V9a4 4 0 0 1 4-4h14 M7 23l-4-4 4-4 M21 13v2a4 4 0 0 1-4 4H3");
...
export const MessageIcon  = icon("M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6");
export const BackIcon     = icon("M19 12H5 M12 19l-7-7 7-7");
export const MoreIcon     = icon("M12 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2z M19 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2z M5 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2z");
export const CloseIcon    = icon("M18 6L6 18 M6 6l12 12");
export const ImgIcon      = icon("M21 19V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2z M8.5 10a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z M21 15l-5-5L5 21");
...
export const SendIcon     = icon("M22 2L11 13 M22 2L15 22 8.5 13.5 2 9z");
export const PollIcon     = icon("M18 20V10 M12 20V4 M6 20v-6");
export const EditIcon     = icon("M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7 M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 7.5-7.5z");
...
export function GhostIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 10h.01M15 10h.01M12 2C6.5 2 2 6.5 2 12v9l3-3 2.5 2.5L10 18l2 2 2-2 2.5 2.5L19 21l3 3v-9c0-5.5-4.5-10-10-10z" />
    </svg>
  );
}

// Verified badge icon (filled checkmark)
export function VBadgeIcon({ size = 16, ...props }: IconProps) {
  return (
